---
name: 文案优化器 / Autoresearch
description: Karpathy 风格内容优化。生成 50+ 变体，5 位模拟专家评分，多轮进化选出最优版。Use when optimizing landing pages, email sequences, ad copy, headlines, form pages, CTA text, or any conversion-focused content. Triggers on "优化这段文案", "run autoresearch", "score these variants", "A/B test this copy".
