---
name: 去除文本AI痕迹 / Humanizer
description: "将 AI 生成文本去痕迹化，转化为自然人类写作风格。检测并修复：虚张声势、促销语言、空洞分析、模糊引用、AI 特征句式等。Use when text reads too much like AI, remove AI traces, make text sound natural, or humanize generated content."
