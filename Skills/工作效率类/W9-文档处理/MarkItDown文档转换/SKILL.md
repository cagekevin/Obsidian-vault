---
name: MarkItDown 文档转换 / Document to Markdown
description: "微软 MarkItDown 文档转 Markdown 工具。支持 PDF/Word/PPT/Excel/图片OCR/音频转写/HTML/YouTube。Use when converting documents to markdown, extracting text from PDFs/images, transcribing audio, or batch-converting files."
