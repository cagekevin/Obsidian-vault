...
### 生物科普参考（micro-bio 专用）
Kurzgesagt · XVIVO Scientific Animation · WEHI · MadMicrobe · Hybrid Medical Animation · Nucleus Medical Media · Random42

### 生物微观视觉（micro-bio 专用）
次表面散射（SSS）· 果冻半透明质感 · 流体模拟 · 细胞膜形变 · 体积光穿透 · 荧光标注 · 电子显微镜扫描质感 · 锁钥咬合动效 · 蛋白柔体物理 · 微观景深 · 栅格锁定框
