...
> **🎨 启动时先问用户：**
> Refero 设计风格库有两种使用方式，你选哪种？
> **A. 你自己下载参考** — 访问 https://styles.refero.design/ 浏览品牌风格，把中意的 DESIGN.md 发给我
> **B. 我用 MCP 搜索** — 如果你已安装 Refero MCP，我直接自动搜索匹配风格
>
> 用户选 A 则等待发来 DESIGN.md 再开始；选 B 则直接通过 MCP 搜索。
