---
name: 网页部署 / HTML Deploy
description: "将单文件 HTML 一键发布到公网，返回可分享链接。Use when HTML page needs quick public sharing, demos, landing pages, or QR-share pages. Triggers on '部署这个页面', '发布到公网', '分享这个页面', 'html deploy'."
