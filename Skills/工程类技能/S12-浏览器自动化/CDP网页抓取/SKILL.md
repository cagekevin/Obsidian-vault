---
name: CDP 网页抓取 / CDP Web Access
description: CDP 直连本地浏览器，支持登录态网页抓取、数据提取、自动化操作。Use when needing to fetch data from login-required sites, scrape protected content, automate browser interactions, or access pages that need cookies/sessions.
