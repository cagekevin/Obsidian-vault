...
def auto_filename(query, output_dir, ext=".png"):
...
def resolve_output(args_output, args_dir,
                   query, ext=".png"):
...
def search_images(query, num=1, size=None,
                  type_filter=None):
...
def fetch_logo(domain, output_path):
...
def print_typst_code(path, width, caption):
    print(f"""#figure(
