---
name: Netlify 项目部署 / Netlify Deploy
description: "使用 Netlify CLI 部署和管理完整前端项目。支持预览部署、生产发布、自定义域名、netlify.toml 配置。Use when deploying production web projects, preview sites, or managing Netlify deployments."
